...
NIGHT_STRENGTH = float(os.environ.get("NIGHT_STRENGTH", 0.85)) # 0..1 (ako silno tlmiť noc)
NIGHT_POWER    = float(os.environ.get("NIGHT_POWER", 1.3))     # >1 = ešte prudšie tlmenie
